...
try {
    ...
    // Debug: Check all responses first
    $allQuery = "SELECT fr.id, fr.question_id, fr.user_id, fr.response_text, fr.created_at, fr.updated_at,
    ...
    // Query dengan JOIN untuk mendapatkan username
    ...
    echo json_encode([
        ...
        'debug' => [
            ...
            'all_responses_in_db' => $allResponses,
